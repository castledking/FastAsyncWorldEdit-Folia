...
public class PaperweightRegen extends Regenerator {
    ...
    protected boolean initNewWorld() throws Exception {
        ...
        WorldOptions originalOpts = server.getWorldGenSettings().options();
        WorldOptions newOpts = options.getSeed().isPresent()
                ? originalOpts.withSeed(OptionalLong.of(seed))
                : originalOpts;
        LevelSettings newWorldSettings = originalWorldData.getLevelSettings().withLevelName("faweregentempworld");
        ...
        WorldGenSettings newWorldGenSettings = new WorldGenSettings(newOpts, server.getWorldGenSettings().dimensions());
        SavedDataStorage savedDataStorage = new SavedDataStorage(
                session.getDimensionPath(originalServerWorld.dimension()),
                server.getFixerUpper(),
                originalServerWorld.registryAccess()
        );
